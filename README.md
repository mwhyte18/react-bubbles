...
When a user logs in with the correct credentials they are given the token to access the privateroute content

- [ ] What steps can you take in your web apps to keep your data secure?

You can add private routes as well as not saving the token in localstorage

- [ ] Describe how web servers work.

Web servers are computers connected to the internet, storing your website code and giving it shared access all around the world
